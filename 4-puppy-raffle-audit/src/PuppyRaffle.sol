...
contract PuppyRaffle is ERC721, Ownable {
    ...
    //@audit : audit-gas this should be a constant
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        //@audit gas-audit : use cashed storage (uint256 playersLength=players.length)
    ...
    // @audit :  Potential Reentrancy vulnerability
    ...
    function selectWinner() external {
        ...
        //@note : Random Rumber Grnerating Check for weak Randomness Exploit (weak PRNG)
        ...
        //@audit : overflow due to typecasting from fee from uint256 to uint64
